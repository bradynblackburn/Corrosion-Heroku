...
# Revamped by Bradyn Blackburn
[Github (with proxy's and other things!)](https://github.com/bradynblackburn)
```
Make sure when using this you give Bradyn Blackburn Credits
```
